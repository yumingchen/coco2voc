...
def parse_instance(content, outdir, target_cls='person):
...
#             if group['category_id']=='person':   #这里可以修改为COCO的其他类别，就可以输出相应的VOC格式文件
            if group['category_id']==target_cls:
    ...
    if args.type == 'instance':
        ...
        for sub_dir in sub_dirs:
            ...
            if not os.path.exists(sub_dir):
                os.makedirs(sub_dir)
        parse_instance(content, args.output_dir, args.target_cls)
...
#                         default = '这里填写COCO的标签路径例如：/Path/to/instances_train2014.json', 
#                         help="annotation file for object instance/keypoint")
#     parser.add_argument("--type", default = 'instance',type=str, 
#                         help="object instance or keypoint", 
#                         choices=['instance', 'keypoint'])
#     parser.add_argument("--output_dir", default = '这里填写生成VOC标签的保存路径', 
#                         help="output directory for voc annotation xml file")
#     parser.add_argument("--anno_file", 
#                         default = '/home/cym/CYM/dataset/COCO2014/coco/annotations/instances_train2014.json', 
#                         help="annotation file for object instance/keypoint")
    
    parser.add_argument("--anno_file", 
                        default = '/home/cym/CYM/dataset/COCO2014/coco/annotations/instances_val2014.json', 
                        help="annotation file for object instance/keypoint")
    parser.add_argument("--type", default = 'instance',
                        type=str, help="object instance or keypoint", 
                        choices=['instance', 'keypoint'])
    parser.add_argument("--output_dir", default = '/home/cym/CYM/dataset/VOC_COCO_persons/data/', 
                        help="output directory for voc annotation xml file")
    parser.add_argument("--target_cls", default = 'person',
                        type=str, help="classes")
